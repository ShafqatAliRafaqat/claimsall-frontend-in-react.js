...
class ACLAdd extends React.Component {
        ...
        return (
            <div>
                <Row type="flex" justify="space-around" align="middle">
                    <Col span={1}/>
                    <Col span={23}>
                        <h3 className='text-left' style={{fontWeight: 900, height: '10vh'}}>Roles
                ...
                <Row type="flex" justify="start">
                    ...
                    <Col span={1}>
                        <Button onClick={() => {
                            ...
                            <Icon type="arrow-left"/>{this.props.backText || "Roles"}
                        </Button>
                    </Col>
                </Row>
...
export default withRouter(ACLAdd);